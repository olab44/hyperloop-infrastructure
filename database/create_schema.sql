...
ALTER TABLE ROUTE_CAPSULE
DROP FOREIGN KEY `fk_CAPSULE_has_ROUTE_ROUTE1`;


ALTER TABLE ROUTE_STRETCH
ADD CONSTRAINT `fk_STRETCH_ID_has_ROUTE_ROUTE1`
FOREIGN KEY (`ROUTE_ID`)
REFERENCES `ROUTE` (`ROUTE_ID`)
ON DELETE CASCADE;
...
ALTER TABLE ROUTE_CAPSULE
ADD CONSTRAINT `fk_CAPSULE_has_ROUTE_ROUTE1`
FOREIGN KEY (`ROUTE_ID`)
REFERENCES `ROUTE` (`ROUTE_ID`)
ON DELETE CASCADE;
...
ALTER TABLE ROUTE_STRETCH
DROP FOREIGN KEY `fk_STRETCH_ID_has_ROUTE_ROUTE1`;
